...
//
// Compares all (odd, even)-indexed pairs of adjacent elements in the list and,
// if a pair is in the wrong order (the first is larger than the second)
// the elements are switched.
